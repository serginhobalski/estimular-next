...
<html lang="pt-br">
  ...
  <head>
    ...
    <meta name="author" content="Sergio Obalski Filho">
              ...
              <div class="col-12">
                  <nav class="main-nav">
                      ...
                      <a href="index.php" class="logo">
                          <!-- Edu Meeting -->
                          <img src="/assets/images/logo-ed.png" alt="">
                      </a>
                      <!-- ***** Logo End ***** -->
                      <!-- ***** Menu Start ***** -->
                      <ul class="nav">
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="meeting-single-item">
                <div class="thumb">
                  ...
                  <a href="curso-detalhe.php"><img src="assets/images/single-meeting.jpg" alt=""></a>
                </div>
                <div class="down-content">
                  <a href="curso-detalhe.php"><h4>Online Teaching and Learning Tools</h4></a>
            ...
            <div class="col-lg-12">
              <div class="main-button-red">
                <a href="cursos.php">Back To Meetings List</a>
              </div>
            </div>
          </div>
        </div>
