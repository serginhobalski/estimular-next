...
<html lang="pt-br">
  ...
  <head>
    ...
    <link rel="shortcut icon" href="/assets/images/logo(symbol-transparent).png" type="image/x-icon">
          ...
          <div class="row">
              <div class="col-12">
                  <nav class="main-nav">
                      ...
                      <a href="#" class="logo">
                          <!-- Estimular Digital -->
                          <img src="/assets/images/logo-ed.png" height="80px" alt="Estimular Digital">
                      </a>
                      <!-- ***** Logo End ***** -->
                      <!-- ***** Menu Start ***** -->
                      <ul class="nav">
            ...
            <div class="col-lg-6">
              <div class="meeting-item">
                <div class="thumb">
                  ...
                  <a href="curso-detalhe.php"><img src="assets/images/meeting-02.jpg" alt="Online Teaching"></a>
                </div>
                <div class="down-content">
                  <div class="date">
            ...
            <div class="col-lg-6">
              <div class="meeting-item">
                <div class="thumb">
                  ...
                  <a href="curso-detalhe.php"><img src="assets/images/meeting-03.jpg" alt="Higher Education"></a>
                </div>
                <div class="down-content">
                  <div class="date">
            ...
            <div class="col-lg-6">
              <div class="meeting-item">
                <div class="thumb">
                  ...
                  <a href="curso-detalhe.php"><img src="assets/images/meeting-04.jpg" alt="Student Training"></a>
                </div>
                <div class="down-content">
                  <div class="date">
